...
typedef struct {
    ...
    std::pair<boost::property_tree::ptree::assoc_iterator,
              boost::property_tree::ptree::assoc_iterator> iterator;
...
PyTypeObject PyPropertyTree_Type = {
    ...
    (char *) "property_tree.Tree",                              /* tp_name */
...
PyTypeObject PyPropertyTree_IterType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "property_tree.TreeIter",                          /* tp_name */
...
PyTypeObject PyPropertyTree_AssocIterType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "property_tree.AssocTreeIter",                     /* tp_name */
...
PyInit_property_tree(void)
{
    ...
    if ((PyPropertyTreeBadDataError_Type = (PyTypeObject*) PyErr_NewException((char*)"property_tree.BadDataError", NULL, NULL)) == NULL) {
        return NULL;
    }
    ...
    if ((PyPropertyTreeBadPathError_Type = (PyTypeObject*) PyErr_NewException((char*)"property_tree.BadPathError", NULL, NULL)) == NULL) {
        return NULL;
    }
    ...
    if (!(PyPropertyTreeJSONParserError_Type = (PyTypeObject*) PyErr_NewException((char*)"property_tree.json.JSONParserError", NULL, NULL))) {
        return NULL;
    }
    ...
    if (!(PyPropertyTreeXMLParserError_Type = (PyTypeObject*) PyErr_NewException((char*)"property_tree.xml.XMLParserError", NULL, NULL))) {
        return NULL;
    }
    ...
    if (!(PyPropertyTreeINIParserError_Type = (PyTypeObject*) PyErr_NewException((char*)"property_tree.ini.INIParserError", NULL, NULL))) {
        return NULL;
    }
    ...
    if (!(PyPropertyTreeINFOParserError_Type = (PyTypeObject*) PyErr_NewException((char*)"property_tree.INFOParserError", NULL, NULL))) {
        return NULL;
    }
